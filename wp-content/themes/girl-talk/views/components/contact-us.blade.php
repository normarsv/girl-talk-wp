<section>
    ...
    <div class="bg-accent">
        <div class="container pt-20 pb-36">
            ...
            <p class="text-xl text-center mt-5">{{$description}}</p>
            <div class="flex flex-col space-y-8 lg:space-y-0 lg:space-x-3 lg:flex-row lg:flex-wrap justify-between items-center mt-20 2xl:px-16">
                @foreach($cards as $card)
                    <div class="bg-accent-light w-full sm:w-80 xl:w-96 py-8 px-5 rounded-md shadow-lg flex flex-col justify-center items-center text-lg">
