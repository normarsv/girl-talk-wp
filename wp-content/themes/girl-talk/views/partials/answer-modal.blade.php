<div class="fixed z-10 inset-0 overflow-y-auto opacity-0 gt-modal" style="display: none" aria-labelledby="answer-modal"
            ...
            <div class="bg-white px-10 py-10">
                <div class="text-center sm:text-left">
                    <div class="flex flex-row justify-start items-center">
                        <h3 class="text-5xl font-title" id="answer-modal">
                            Answer
                        </h3>
                        <div class="p-5">
                            {{$question}}
